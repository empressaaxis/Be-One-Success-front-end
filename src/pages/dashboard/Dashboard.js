  ...
  return (
    <div className='bg-[rgb(24,39,71)] w-full h-full'>
        ...
        <div className='w-[1000px] mx-auto mt-10'>
            <h1 className='text-white text-[45px] font-bold mb-5'>Status</h1>
            <div className='w-[400px] h-[180px] rounded-[20px] pt-5 bg-[#e5e5e5]'>
                ...
                <p className='mx-10 font-light mt-5'>You have not yet applied to any application, please apply at any open application <Link className='text-[#006494]' to='/applications'>Here</Link>.</p>
            </div>
        </div>
    </div>
  )
