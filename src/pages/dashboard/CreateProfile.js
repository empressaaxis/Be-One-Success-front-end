  ...
  return (
    <div className='w-full h-full bg-[rgb(24,39,71)]'>
        ...
        <div className='w-[600px] h-[670px] mt-20 rounded-[20px] bg-[#e5e5e5] ml-[600px] pt-[10px] px-10'>
            <h1 className='font-semibold text-[30px] text-center'>Complete Your profile</h1>
            <div className='w-full flex justify-between mt-10 mb-5'>
                ...
                <div className='flex flex-col'>
                    <label className='mb-2'>Parent/Guardian</label>
                    <input className='border-[1px] border-[rgb(24,39,71)] w-[250px] h-[40px] p-2 rounded-[10px] bg-[#e5e5e5]' />
                </div>
            ...
            <div className='w-full flex justify-between mb-5'>
                <div className='flex flex-col'>
                    <label className='mb-2'>Level of Education</label>
                    <input className='border-[1px] border-[rgb(24,39,71)] w-[250px] h-[40px] p-2 rounded-[10px] bg-[#e5e5e5]' />
                </div>
                <div className='flex flex-col'>
