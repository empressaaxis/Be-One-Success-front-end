...
<footer className="p-4 bg-[#006494] sm:p-6 dark:bg-gray-900">
    <div className="md:w-full md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <p href="#" className="flex items-center font-extrabold text-[#e7ab21]">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
                <h2 className="mb-6 text-sm font-semibold uppercase text-white">Mobile App</h2>
                <ul className="text-white">
                    <li className="mb-4">
                        <a href="https://github.com/themesberg/flowbite" classNameName="hover:underline ">Android</a>
                    </li>
                    <li>
                        <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">iOS</a>
                    </li>
                </ul>
            </div>
            <div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm sm:text-center text-white">© 2022 <a href="https://flowbite.com/" className="hover:underline">Be One Success™</a>. All Rights Reserved.
        </span>
